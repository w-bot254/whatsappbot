...
cmd({
    ...
    try {
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your HUNTER XMD bot is already up-to-date!");
        }

        await reply("🚀 Updating HUNTER XMD Bot...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/ObedTech515/HUNTER-XMD1/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "HUNTER-XMD-main");
